...
{
    [Obsolete("Rename to MemberInfo extensions...")]
    internal static class Attributes
    {
        ...
        public static T GetFirst<T>(this MemberInfo type) where T : Attribute
        {
        ...
        public static T GetFirstInherited<T>(this MemberInfo type) where T : Attribute
        {
        ...
        private static T GetFirstCore<T>(this MemberInfo type, bool inherited) where T : Attribute
        {
